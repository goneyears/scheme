...
(define (start-prime-test n start-time)
  (if (f1-prime? n)   (report-prime ( - (runtime) start-time))
  (display "****")))
(define (report-prime elapsed-time)
  (display "***")
  (display elapsed-time))
(define (find-prime-more-than n)
  (if (f-prime? n) (timed-prime-test n)
...
(define (f-prime? n)
  (fast-prime n 10))
(define (large-random n)
  (if (< n 4294967087) (+ 1 (random (- n 1)))
          ( if (even? n) (* (large-random (/ n 2)) 2)
               (+ (random 1) (large-random (- n 1))))))
(define (f1-prime? n)
  (fast-prime n 1000))          
(f-s 10 10)